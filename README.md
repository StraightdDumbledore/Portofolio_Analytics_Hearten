...
<a href="https://github.com/StraightdDumbledore/Portofolio_Analytics_Hearten/tree/Factor-That-Make-a-Car-Salable" title="Identified different factor for a car can be sold in many other ways
">Analyze Factor Which All the Car can be sold in predetermined Car</a></p> | Identified and giving suggestion the factors that effect the price of a Car | pandas, matplotlib, seaborn
